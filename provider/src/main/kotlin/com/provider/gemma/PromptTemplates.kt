...
object PromptTemplates {
    ...
    /** 앙상블 OCR 교차검증 프롬프트 (법인사업자) */
    val ENSEMBLE_CROSS_VALIDATION_CORPORATE =
            """
        ### ROLE
        너는 OCR 결과 교차검증 전문가이다. 3개 OCR 엔진(PaddleOCR, Pororo, OnnxTR)의 결과를 비교하여 가장 정확한 값을 선택하라.
        ...
        ### ✅ 정상 문자 판별 기준
        - 한글 텍스트: "주식회사 마이제이디", "이임순"
        - 숫자 패턴: "476-81-00434", "2015년 12월 01일"
        - 주소: "경기도 남양주시 화도읍..."
        ...
        {
          "documentType": "법인사업자",
          "businessNumber": "선택된 사업자등록번호",
          "merchantName": "선택된 법인명",
          "representativeName": "선택된 대표자명",
          "openingDate": "YYYY년 MM월 DD일",
          "corporateNumber": "XXXXXX-XXXXXXX",
          "address": "사업장 소재지",
          "headOfficeAddress": "본점 소재지",
    ...
    /** 앙상블 OCR 교차검증 프롬프트 (개인사업자) */
    val ENSEMBLE_CROSS_VALIDATION_INDIVIDUAL =
            """
        ### ROLE
        너는 OCR 결과 교차검증 전문가이다. 3개 OCR 엔진(PaddleOCR, Pororo, OnnxTR)의 결과를 비교하여 가장 정확한 값을 선택하라.
